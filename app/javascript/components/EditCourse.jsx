...
export default () => {
    ...
    const onChangeName = (event) => setCourse(course => ({...course, name: event.target.value}));
        ...
        <div className="container mt-5">
            ...
            <div className="row">
                <div className="col-sm-12 col-lg-6 offset-lg-3">
                    ...
                    <CourseForm course={course} onChangeName={onChangeName} onSubmit={onSubmit} />
                </div>
            </div>
        </div>
    );
