json.partial! 'api/v1/partner/courses/course', course: @course
...
json.partial! 'api/v1/partner/assignments/assignees', assignable: @course
...
json.milestones do
    json.array! @course.milestones do |milestone|
        ...
        json.partial! 'api/v1/partner/assignments/assignees', assignable: milestone
        json.lessons do
            json.array! milestone.lessons do |lesson|
                ...
                json.partial! 'api/v1/partner/assignments/assignees', assignable: lesson
            end
        end
    end
end
